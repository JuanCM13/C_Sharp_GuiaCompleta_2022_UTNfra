...
namespace EnciendanSusMotores_4._0
{
        ...
        where T  : VehiculoDeCarrera
    {
        ...
        public static bool operator ==(Competencia<T> com, VehiculoDeCarrera v)
        {
            bool ret = false;
        ...
        public static bool operator +(Competencia<T> com, T v)
        {
            bool ret = false;
            ...
            if (!(com is null) && !(v is null))
            {
                if (com.competidores.Count + 1 <= com.cantidadCompetidores)
                {
                    try
                    {
                        if (com != v)
                        {
                            v.CantidadCombustible = (short)Competencia<T>.auxR.Next(15, 100);
